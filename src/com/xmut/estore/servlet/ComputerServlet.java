...
public class ComputerServlet extends HttpServlet {
	...
	// 添加到购物车（商品详情页添加）
	protected void addToCartInside(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// 1. 获取商品的 id
		String idStr = request.getParameter("id");
		int id = -1;
	...
	protected void getComputer(HttpServletRequest request, HttpServletResponse response)
	...
	protected void getComputers(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		...
		System.out.println(request.getAttribute("computerpage"));
